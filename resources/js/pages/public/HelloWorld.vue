<template>
  <v-container>
    <v-row class="text-center">
      <v-col cols="12">
        <v-img
          src="https://img2.freepng.fr/20180407/qcq/kisspng-vue-js-javascript-framework-front-and-back-ends-gi-technical-5ac9109e8adb43.6860172915231264305688.jpg"
          class="my-3"
          contain
          height="200"
        />
...
export default Vue.extend({
  ...
  methods: {
    showSwal() {
      this.$swal('worked', `${this.$shortDateFormat('01/02/1998')}`, 'success');
    }
  }
});
</script>
